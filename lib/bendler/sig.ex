defmodule Bendler.Sig do
  ...
  takes a final unary handler argument. An export has one callback channel,
  ask or emit, not both, on Port and the experimental NIF. An abandoned NIF
  ask freezes its module; use Port for restartable failures.
